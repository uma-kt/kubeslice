...
See [Kubeslice Reference Architecture](https://kubeslice.io/documentation/open-source/0.5.0/architecture) to get an overview of the overall architecture and core components.
